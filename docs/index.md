...
-   :material-file-pdf-box:{ .lg .middle } **Guía 1: Probabilidad Clásica y Condicional**
    ...
    [⬇️ Descargar PDF](pdfs/guia1.pdf){ .md-button .md-button--primary }
    [👁️ Ver en Navegador](pdfs/guia1.pdf){ .md-button target="_blank" }
...
-   :material-file-pdf-box:{ .lg .middle } **Guía 2: Variables Aleatorias Discretas**
    ...
    [⬇️ Descargar PDF](pdfs/guia2.pdf){ .md-button .md-button--primary }
    [👁️ Ver en Navegador](pdfs/guia2.pdf){ .md-button target="_blank" }
...
-   :material-file-pdf-box:{ .lg .middle } **Guía 3: Distribuciones Continuas**
    ...
    [⬇️ Descargar PDF](pdfs/guia3.pdf){ .md-button .md-button--primary }
    [👁️ Ver en Navegador](pdfs/guia3.pdf){ .md-button target="_blank" }
